...
public class Actual  {
    ...
    public Actual( String currency, String currencyAcronym, double exchangeRate, double difference, LocalDateTime publishedDate, long revisionNo) {
